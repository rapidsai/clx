...
input_rows = [['movierulz.com','1'], ['studytour.com.tw','1'], ['bankmobile.com','1'], ['bakercityherald.com','0']]
dataset = DGADataset()
...
def test_train_model(model, optimizer, criterion, data_loader):
    service = RNNClassifierService(model, optimizer, criterion, train_loader=data_loader)
