...
def hash_vocab(path, store_path, compact, unk_tok="[UNK]", first_token="[CLS]", sep_token="[SEP]"):
    ...
    store_func(store_path, outer_a, outer_b, num_outer_bins, hash_table, inner_table_coeffs, offsets_into_ht, vocab[unk_tok], vocab[first_token], vocab[sep_token])
...
def store_func(out_name, outer_a, outer_b, num_outer_bins, hash_table, inner_table_coeffs, offsets_into_ht, unk_tok_id, first_token_id, sep_token_id):
