...
def test_splunk_notable_parser():
    ...
    assert test_output_df4["owner"][0] == ""
    assert test_output_df4["security_domain"][0] == ""
    assert test_output_df4["severity"][0] == ""
    assert test_output_df4["src_ip"][0] == ""
    assert test_output_df4["src_mac"][0] == ""
    assert test_output_df4["src_port"][0] == ""
    assert test_output_df4["dest_ip"][0] == ""
    assert test_output_df4["dest_mac"][0] == ""
    assert test_output_df4["dest_port"][0] == ""
    assert test_output_df4["dest_priority"][0] == ""
    ...
    assert test_output_df5["urgency"][0] == "medium"
    assert test_output_df5["user"][0] == ""
    assert test_output_df5["owner"][0] == "test@nvidia.com"
    assert test_output_df5["security_domain"][0] == "endpoint"
    assert test_output_df5["severity"][0] == ""
    assert test_output_df5["src_ip"][0] == ""
    assert test_output_df5["src_mac"][0] == ""
    assert test_output_df5["src_port"][0] == ""
    assert test_output_df5["dest_ip"][0] == ""
    assert test_output_df5["dest_mac"][0] == ""
    assert test_output_df5["dest_port"][0] == ""
    assert test_output_df5["dest_priority"][0] == ""
    ...
    assert test_output_df6["owner"][0] == ""
    assert test_output_df6["security_domain"][0] == ""
    assert test_output_df6["severity"][0] == "minr"
    assert test_output_df6["src_ip"][0] == "10.15.90.151"
    assert test_output_df6["src_mac"][0] == ""
    assert test_output_df6["src_port"][0] == "40472"
    assert test_output_df6["dest_ip"][0] == "10.15.90.150"
    assert test_output_df6["dest_mac"][0] == ""
    assert test_output_df6["dest_port"][0] == "80"
    assert test_output_df6["dest_priority"][0] == ""
