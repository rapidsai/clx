...
void GpuWordPieceTokenizer::tokenize(ptr_length_pair<uint32_t*>& cp_and_length, 
  ...
  gpuWordPieceTokenizer<<<num_wp_blocks, wp_threads_per_block>>>(device_code_points, thrust::raw_pointer_cast(device_hash_table.data()), device_bin_coefficients, device_bin_offsets, 
