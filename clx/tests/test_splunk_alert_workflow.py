...
def test_splunk_alert_workflow(threshold, interval, window):
    ...
    input_df = cudf.DataFrame(
        [
            ...
            ("user", [None,None,"testuser",None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,]),
    ...
    expected_df["Threat - Source And Destination Matches - Threat Gen_flag"] = [False,False,False,False,False,False,False,False,False,False,False,False,False,False,True,False,False,False,False,False]
