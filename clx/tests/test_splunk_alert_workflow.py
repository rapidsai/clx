...
def test_splunk_alert_workflow(threshold, interval, window):
    ...
    expected_df["Test Search Name 3_flag"] = [
        False,
        False,
        False,
        False,
    ...
    expected_df["Test Search Name 2_flag"] = [
        False,
        False,
        False,
        False,
    ...
    expected_df["Test Search Name_flag"] = [
        False,
        False,
        False,
        False,
    ...
    expected_df["Manual Notable Event - Rule_flag"] = [
        False,
        False,
        False,
        False,
    ...
    expected_df[
        "Endpoint - Host With Malware Detected (Quarantined or Waived) - Rule_flag"
    ] = [
        False,
        False,
        False,
    ...
    expected_df[
        "Endpoint - FireEye NX alert for Incident Review (Minor) - Rule_flag"
    ] = [
        False,
        False,
        False,
    ...
    expected_df["Endpoint - Brute Force against Known User - Rule_flag"] = [
        False,
        False,
        False,
        False,
